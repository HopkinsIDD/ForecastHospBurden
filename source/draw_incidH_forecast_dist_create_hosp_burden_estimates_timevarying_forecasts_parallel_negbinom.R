...
los_opt_by_state_season <- read_csv("data/US_wide_data/LOS_Optimized_by_AllStates_USA_time_varying_nbinom.csv")
...
write_parquet(all_states_samples_los, "data/US_wide_data/all_states_samples_los_negbinom_03192025.csv")

all_states_samples_los <- read_parquet("data/US_wide_data/all_states_samples_los_negbinom_03192025.csv")
...
write_parquet(covid_joined_totalHosp_state_data_los_demographic, "data/US_wide_data/estimated_hospitalizations_data/Obs_Exp_totalHosp_daily_TIMEVARYING_FORECAST_SIMU_quantiles_14days_parallel_negbinom_03192025.parquet")
